/**
 * OMNIVORE AGENT — ESP32-S3 Cold-Chain Sensor Reporter & OLED Display
 * 
 * Hardware:
 *   - ESP32-S3-DevKitC-1
 ...
 *   2. Sends periodic HTTP telemetry to OMNIVORE AGENT backend (/api/esp32/events).
...
void setupDisplay() {
  ...
  display.println("OMNIVORE AGENT");
...
void renderOLED() {
  ...
  display.print("OMNIVORE // COLD-S3");
